...
Treat naming as a decision about meaning, boundary, audience, and future use. A good name is not the longest description or the most complete word bundle; it carries the right information for the context where it will be read, searched, spoken, maintained, or used by tools.
...
- What exposure, durability, or tooling surface determines how much context the name must carry?
...
- What must this name distinguish from nearby names, and what difference is the user likely to care about first?
...
- Match local naming shape before applying generic preference.
