...
- Is this no durable change because the issue was a one-off bug, transient misunderstanding, private fact, session-specific detail, preference that only applied once, or constraint that should not be generalized?
